	...
	// DB Connection
		public Connection connect() {
			...
			try {
				...
				con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:33076/product", "root", "");
		...
		public String readProduct() {
			...
			try {
				...
				// Prepare the html table to be displayed
				output = "<table border='1'><tr><th> Prod_ID </th>"
						+" <th> Product_Code </th> "
						+" <th> Prod_Name </th> " 
						+" <th> Contributors </th> "  
						+" <th> 	Emailt </th> "
				...
				while (rs.next()) {
					...
					String Prod_ID  = Integer.toString(rs.getInt("Prod_ID"));
					String Product_Code = rs.getString("investorName");
					String Prod_Name = rs.getString("Prod_Name");
					String Contributors = rs.getString("Contributors");
					String Email = rs.getString("Email");
					String Price = Double.toString(rs.getDouble("Price"));
					...
					output += "<td><input name='btnUpdate' type='button' value='Update' "
							+ "class='btnUpdate btn btn-secondary' data-itemid='" + Prod_ID + "'></td>"
							+ "<td><input name='btnRemove' type='button' value='Remove' "
							+ "class='btnRemove btn btn-danger' data-itemid='" + Prod_ID + "'></td></tr>";
				}
